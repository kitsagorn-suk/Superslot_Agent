<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="goal.aspx.cs" Inherits="Pretty_Gaming.Menu_Daily.goal" %>
        ...
        <table class="table table-border" id="tbData">
            <thead class="rgba-green-slight">
                <tr>
                    ...
                    <th style='width: 5%;' set-lan='text:Day'></th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="form-group row">
                        <label for="username" class="col-4 col-form-label" style="text-align: right;" set-lan="text:Day-"></label>
                        <div class="col-8">
                            <input type="text" id="Goal" class="form-control" autocomplete="off" disabled />
                        </div>
                    </div>
                    <div class="form-group row">
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    <script>
        ...
        const getData = async () => {
            const requestAwait = await fetchDataSite(`${apiURL}/v1/dailyReward/goal/get`, 'GET', "include", {})
            ...
            if (response.messageCode == 0000 || response.messageCode == null) {
                ...
                if (response.data != null) {
                    for (var i = 0; i < response.data.length; i++) {
                        ...
                        htmlData += "<td class='aligncenter'>" + obj.day + "</td>";
                        htmlData += "<td class='alignright'>" + turnover + "</td>";
                        htmlData += "<td style='width: 1%;' class='aligncenter colEdit zonenone'><a class='link' onclick='btnEdit(`" + obj.id + "`,`" + obj.day + "`,`" + turnover + "`)'><i class='fas fa-pencil-alt'></i></a></td>";
                        htmlData += "</tr>";
                        no++;
                    }
        ...
        const postEdit = async () => {
            ...
            const requestAwait = await fetchDataSite(`${apiURL}/v1/dailyReward/goal/adjust`, 'POST', "include", parameter)
            const response = await requestAwait.json()
