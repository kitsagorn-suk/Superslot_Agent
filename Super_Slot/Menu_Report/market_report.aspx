<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="market_report.aspx.cs" Inherits="Pretty_Gaming.Menu_Report.market_report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active txtMem" set-lan="text:Market Report"></li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-8">
            <h1 set-lan="text:Market Report"></h1>
        </div>
    </div>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainScript" runat="server">
    ...
    <script type="text/javascript">      
        ...
        const postData = async (status, userID, username, num) => {
            ...
            var parameter = {};
            if (status == 1) {
                URL = `${apiURL}/v1/market/report/stakeholder_payment`;
                parameter = {
                ...
                URL = `${apiURL}/v1/market/report/redeem_history`;
                parameter = {
                    startDate: $("#startdate").val(),
                    startTime: $("#starttime").val() + ":00",
                    endDate: $("#todate").val(),
